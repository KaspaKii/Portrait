...
//! cargo run -p kcp-paired-attestation --example paired_attestation_onchain_evidence --features wrpc
//! ```
//!
...
async fn main() -> Result<(), BoxError> {
    ...
    println!(
        "  source: crates/kcp-paired-attestation/examples/paired_attestation_onchain_evidence.rs"
    );
